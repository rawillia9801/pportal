      ...
      <div className="mainArea">
        ...
        <section className="hero">
          <div className="heroInner">
            <div className="heroText">
              <h1>
                Welcome to <em>My Puppy Portal</em>
              </h1>
              <p className="lead">
                Your central hub to follow your Chihuahua puppy’s journey — from applications and payments to weekly
                milestones, documents, and transport.
              </p>
            </div>

            {/* Sign Up card centered under heading */}
            <form className="signup" onSubmit={onSignUp}>
              ...
              {(!getSupabaseEnv().url || !getSupabaseEnv().key) && (
                <div className="note" style={{ marginTop: 8 }}>
                  ...
                  <code>NEXT_PUBLIC_SUPABASE_ANON_KEY</code> in your environment (or attach to <code>window</code> for
                  local sandboxing).
                </div>
              )}
            </form>
        ...
        <section className="about">
          <div className="wrap">
            ...
            <p>
              A friendly, secure dashboard for Southwest Virginia Chihuahua families. Track your puppy’s weekly weights
              and milestones, view and sign your documents, manage payments, schedule transportation, and chat with us —
              all in one place.
            </p>
          </div>
        </section>
...
function DevSelfTests() {
  const [{ results, running }, setState] = useState<{ results: TestResult[]; running: boolean }>({
    results: [],
    running: true,
  })
    ...
    <section className="tests">
      <div className="panel">
        ...
        <div className="mini" style={{ marginBottom: 8 }}>
          Append <code>?dev=1</code> to the URL to toggle. These are smoke tests, not end-to-end.
        </div>
